    ...
    if (lastMessage) {
        ...
        switch (messageBody.type) {
            case EMMessageBodyTypeImage:{
                latestMessageTitle = NSLocalizedString(@"im.message.image", nil);
            } break;
            ...
            case EMMessageBodyTypeVoice:{
                latestMessageTitle = NSLocalizedString(@"im.message.audio", nil);
            } break;
            case EMMessageBodyTypeLocation: {
                latestMessageTitle = NSLocalizedString(@"im.message.position", nil);
            } break;
            case EMMessageBodyTypeVideo: {
                latestMessageTitle = NSLocalizedString(@"im.message.video", nil);
            } break;
            case EMMessageBodyTypeFile: {
                latestMessageTitle = NSLocalizedString(@"im.message.file", nil);
            } break;
            default: {
            } break;
        }
