...
//  Audio
//
//  Created by 胡伟伟 on 2019/12/25.
//  Copyright © 2019 judy. All rights reserved.
//

#import "SGGCDManager.h"

@interface SGGCDManager()

@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;

@end
@implementation SGGCDManager
#pragma mark - Public Method

+ (SGGCDManager *)sharedInstance
{
    static SGGCDManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[SGGCDManager alloc] init];
    });
